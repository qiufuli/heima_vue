...
//  所以要用的话 需要用 vue/dist/vue.js 而不是vue.runtime.common.js
// 回顾 包的查找规则：
...
// var login = {
//     template:'<h1>只是login组件 是使用网页的形式创建的组件</h1>'
// }
...
// 7. 在页面中创建一个 id 为 app 的 div 元素，作为我们 vm 实例要控制的区域；
 ...
 console.log(m1,title,content) // {xxx} 小星星 哈哈